...
Item {
    ...
    readonly property int workspacesShown: ConfigOptions.launcher.rows * ConfigOptions.launcher.columns
    ...
    property real scale: ConfigOptions.launcher.scale
    ...
    implicitWidth: launcherBackground.implicitWidth + Appearance.sizes.elevationMargin * 2
    implicitHeight: launcherBackground.implicitHeight + Appearance.sizes.elevationMargin * 2

    property Component windowComponent: LauncherWindow {}
    property list<LauncherWindow> windowWidgets: []
    ...
    Rectangle { // Background
        ...
        ColumnLayout { // Workspaces
            ...
            Repeater {
                model: ConfigOptions.launcher.rows
                delegate: RowLayout {
                    id: row
                    ...
                    Repeater { // Workspace repeater
                        model: ConfigOptions.launcher.columns
                        Rectangle { // Workspace
                            id: workspace
                            property int colIndex: index
                            property int workspaceValue: root.workspaceGroup * workspacesShown + rowIndex * ConfigOptions.launcher.columns + colIndex + 1
        ...
        Item { // Windows & focused workspace indicator
            ...
            Repeater { // Window repeater
                ...
                delegate: LauncherWindow {
                    ...
                    property int workspaceColIndex: (windowData?.workspace.id - 1) % ConfigOptions.launcher.columns
                    property int workspaceRowIndex: Math.floor((windowData?.workspace.id - 1) % root.workspacesShown / ConfigOptions.launcher.columns)
                    ...
                    Timer {
                        ...
                        onTriggered: {
                            ...
                            // console.log(`[OLauncherWindow] Updated position for window ${windowData?.address} to (${window.x}, ${window.y})`)
                        }
                    }
                    ...
                    MouseArea {
                        ...
                        onPressed: {
                            ...
                            // console.log(`[LauncherWindow] Dragging window ${windowData?.address} from position (${window.x}, ${window.y})`)
                        }
                        onReleased: {
            ...
            Rectangle { // Focused workspace indicator
                ...
                property int activeWorkspaceRowIndex: Math.floor((activeWorkspaceInGroup - 1) / ConfigOptions.launcher.columns)
                property int activeWorkspaceColIndex: (activeWorkspaceInGroup - 1) % ConfigOptions.launcher.columns
